    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrapDash").Include(
                "~/Dashboard/assets/jquery/jquery-3.1.0.min.js",
                        "~/Dashboard/assets/tether/tether.min.js",
                        "~/Dashboard/assets/bootstrap/bootstrap4-alpha3.min.js",
                        "~/Dashboard/assets/bootstrap/bootstrap4-alpha3.min.js",
                        "~/Dashboard/assets/script/canvasjs.min.js",
                      "~/Scripts/bootstrap.js",
                      "~/Scripts/respond.js",
                      "~/Content/Selectize/js/standalone/selectize.min.js",
                      "~/Scripts/moment.js",
            ...
            bundles.Add(new StyleBundle("~/bundles/Dash").Include(
                "~/Repository/assets/bootstrap/bootstrap4-alpha3.min.css",
                "~/Scripts/bootstrap/css/bootstrap.min.css", "~/Scripts/font-awesome/css/font-awesome.min.css", "~/Scripts/css/fontastic.css",
                 "~/Scripts/css/grasp_mobile_progress_circle-1.0.0.min.css",
                "~/Scripts/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css", "~/Scripts/css/style.default.css"));
        }
